...
import unittest
import difflib
import RestutilsTestSupport              # must be imported before docutils
import docutils
...
class FunctionalTestSuite(RestutilsTestSupport.CustomTestSuite):

    """Test suite containing test cases for all config files."""

    def __init__(self):
        """Process all config files in functional/tests/."""
        RestutilsTestSupport.CustomTestSuite.__init__(self)
        os.chdir(RestutilsTestSupport.testroot)
...
class FunctionalTestCase(RestutilsTestSupport.CustomTestCase):
...
expected output and check it in:
  ...
  svn commit -m "<comment>" %(exp)s"""
    ...
    def __init__(self, *args, **kwargs):
        ...
        RestutilsTestSupport.CustomTestCase.__init__(self, *args, **kwargs)
